          ...
          <div className="groupbar" key={group.id}>
            <button
              onClick={async () => {
                ...
                let response = await Axios.put('https://localhost:4000/api/groups/', {id:group.id});
            ...
            <li
              ...
              onClick={async () => {
                ...
                let newGroupName = await Axios.get(
                  "https://localhost:4000/api/groups/" + group.id
                );
            ...
            <button
              ...
              onClick={async () => {
                ...
                await Axios.put("https://localhost:4000/api/groups/remove",{
